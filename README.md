...
Esse projto tem como desenvolvimento MQTT para monitoramento do rack ultiluzando ARDUINO e aplicativo de celular para monitamento das portas do rack
avisando quando estiver ABERTA e FECHADO mandando uma mensagem para o servidor AWS que repassa o avsio para o aplicativo de celular [MQTT DASH](https://play.google.com/store/apps/details?id=net.routix.mqttdash&hl=en&gl=US)
